...
public class Test {
    public static void main(String[] args) throws Exception {
        ResultSet rs = rs();
        Stream<Row> rows = StreamSupport.stream(new ResultSetIterable(rs).spliterator(), false);
    ...
    public static ResultSet rs() throws Exception{
        ...
        Session session = () -> DriverManager.getConnection("jdbc:hsqldb:mem:employees", "abc", "abc");
        new StatementUpdate(
            session,
            new QuerySimple(
                new Joined(
